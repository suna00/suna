...
<%@ include file="../order/cfg/site_conf_inc.jsp" %>
<%
    ...
    System.out.println("Ret_URL : "+Ret_URL);
    ...
    out.println( suc.kcpPaymentSmartPhone( request, g_conf_server, pd, g_conf_pay_log_dir) ); // 이클립스 상에서 메서드를 클릭 후 F2를 누르면 상세 내용이 나옵니다.
%>