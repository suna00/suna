...
CREATE INDEX IDX_MT_ALBUM ON MT_ALBUM (ALBUM_ID);
CREATE INDEX IDX_MT_ARTIST ON MT_ARTIST (ARTIST_ID);
CREATE INDEX IDX_MT_SONG ON MT_SONG (SONG_ID);
CREATE INDEX IDX_MT_MV ON MT_MV (MV_ID);
CREATE INDEX IDX_MT_CHARTMST ON T_SM_S3_ChartTotalMst (MstIdx);
CREATE INDEX IDX_MT_CHARTLST ON T_SM_S3_ChartTotalLst (Idx);