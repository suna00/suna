...
public class CommonService {
    ...
    static
    {
        ...
        resultCodeMap.put("U0007", "비밀번호 변경 안내.회원님의 비밀번호 변경이 필요한 시기입니다.");
        resultCodeMap.put("U0008", "로그인 성공");
        resultCodeMap.put("U0009", "로그인 실패");
        resultCodeMap.put("U0010", "로그인 사용자");
        resultCodeMap.put("U0011", "비로그인 사용자");
        resultCodeMap.put("U0012", "휴면계정 사용자");
        resultCodeMap.put("U0013", "휴면지속자동탈퇴 사용자");
