...
public class MemberService {
    ...
    public void authenticationSendEmail(ExecuteContext context) throws MessagingException {
        Map<String, Object> data = context.getData(); //certCode=11111&siteType=company&email=yeon0153@i-on.net
        String certCode = data.get("certCode").toString();
        String siteType = data.get("siteType").toString();
        String email = data.get("email").toString();
        String link = "&certCode="+certCode+"&siteType="+siteType;
        ...
        String html = "<!DOCTYPE html>\n" +
                ...
                "                        <img src=\"http://localhost/assets/images/email/logo_store.png\" alt=\"YGOON 교육할인스토어\" style=\"border:0;\">\n" +
                "                    </td>\n" +
                "                </tr>\n" +
                "            </table>\n" +
                "\n" +
                ...
                "                                    <p style=\"padding-top:16px;color:#ff0000;\"><strong>인증 유효시간</strong> : 2017-07-20 / 04:20:20</p>\n" +
                "                                </td>\n" +
                "                            </tr>\n" +
                "                            <tr>\n" +
                ...
                "                            <img src=\"http://localhost/assets/images/email/logo_store.png\" alt=\"YGOON 교육할인스토어\" width=\"111\" style=\"border:0;\">\n" +
                "                        </p>\n" +
                ...
                "</body>\n" +
                "</html>\n";
        //mimeBodyPart.setText("link="+link);
